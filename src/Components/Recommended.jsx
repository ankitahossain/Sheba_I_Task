      ...
      <div className='px-3 py-6 flex flex-col items-center'>
        ...
        <div className='flex flex-wrap justify-center gap-x-10 gap-y-6'>
          <img 
            src={recom_1} 
            alt="recom_1" 
            className='w-full sm:w-[220px] h-auto object-contain rounded-lg shadow-md hover:shadow-xl cursor-pointer hover:border-2 hover:border-purple-400 transition-all duration-300' 
          />
          <img 
            src={recom_2} 
            alt="recom_2" 
