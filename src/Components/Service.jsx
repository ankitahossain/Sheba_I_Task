  ...
  <div className="px-2 sm:px-3 py-6 bg-white_color">
    <div className="px-1 sm:px-4 py-6 relative">
      <div className="bg-bg_color relative">
        ...
        {/* Service Card */}
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-6 md:gap-4 absolute top-0 left-0 w-full h-full px-2 sm:px-0">
          {/* Left Service Card  */}
          <div className="flex flex-col items-center md:items-start gap-3 w-full md:w-[46%] md:ml-[6%] bg-white/80 md:bg-transparent rounded-lg p-3 md:p-0">
            <h1 className="font-lato font-bold text-2xl sm:text-3xl md:text-[48px] text-black_color text-center md:text-left">Get your service from our app</h1>
            <p className="font-font-open-sans font-regular text-[15px] sm:text-[16px] text-font_color text-center md:text-left">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some.</p>
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start items-center mt-4">
              {/* App Store Button */}
              <button
                type="button"
                className="flex items-center px-4 py-2 bg-black hover:bg-[#222] text-white rounded-lg transition duration-200 w-44 sm:w-auto"
              >
                <svg
          ...
          <div className="w-full max-w-[320px] sm:max-w-[370.78px] h-[220px] sm:h-[320px] md:h-[495px] flex justify-center items-center mx-auto md:mx-0">
            <img src={service} alt="service" className="w-full h-full object-contain md:ml-[60%]" />
          </div>
        </div>
      </div>
    </div>
